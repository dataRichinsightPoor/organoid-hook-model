...
Figure 1. Accumulation-format simulations at 72 hours. The transport stress case is not spatially converged and is included to expose sensitivity to tissue geometry, not to predict penetration quantitatively.
