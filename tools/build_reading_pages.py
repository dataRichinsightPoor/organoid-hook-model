...
for name,source,title in [
 ...
 ("article.html","the-hook-is-a-property-of-the-system.md","The Hook Is a Property of the System"),
 ("worked-example.html","worked-example.md","Follow one simulation"),
    ...
    helper = "" if name == "article.html" else f"""<p class="math-help">Synthetic, uncalibrated research software · v0.1.0.
